...
// The weekly-session event log, formerly its own page at /history — folded in
// here since the two are the same community, just its present and its past.
// Each season is a collapsed <details>; new seasons go at the top.
const seasons = [
  {
...
const NamedDefault = () => (
  <Page2026 active="/community">
    ...
    <Article2026>
      ...
      <h2 style={sectionHeading}>A patient unfolding, week by week since 2021</h2>
      <p style={bodyP}>
      ...
      <h3 style={historyHeading}>Historical event log</h3>
