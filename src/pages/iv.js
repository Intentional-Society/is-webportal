...
const NamedDefault = () => (
  <Page2026 active="/iv">
    ...
    {/* ======== Header band ======== */}
    <HeaderBand
      image="willow.jpg" focus="center 40%" credit="Karla"
      title={PAGE.title}
    ...
    <Article2026>
      ...
      <p style={bodyP}>
        The first goal of IV is to <strong>catalyze aligned livelihoods</strong> for
        individuals in service to human thriving. The second goal of IV is to create
        a <strong>relational economic web</strong> of abundance with
      ...
      <ul style={bodyUl}>
        <li style={bodyLi}><strong>Rational-professional skill</strong>: systematic thought, self-management, conventional professional skills</li>
        <li style={bodyLi}><strong>Interpersonal skill</strong>: self-awareness, communication, robust emotional capacity and relational agility</li>
        <li style={bodyLi}><strong>Perspectival-developmental skill</strong>: fluid perspective-taking, complexity lens, metasystematicity</li>
      </ul>
