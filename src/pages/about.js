...
// 2026 redesign of the About page — self-contained page (own nav/footer) ported
// from the "About v2" Claude Design mockup, matching the pattern established by
// the redesigned homepage (src/pages/index.js): no <Layout>/MUI theme, Cormorant
// Garamond + DM Sans via Google Fonts, images in static/design2026/.
...
const navLinks = [
  { text: 'About', to: '/about', active: true },
...
export const Head = () => (
  <>
    <title>About — Intentional Society</title>
    <meta name="description" content="A society we are creating on purpose — who we are, what we do, and how membership works at Intentional Society." />
