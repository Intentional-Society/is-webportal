...
export const CONNECTION_CALL_URL = 'https://us02web.zoom.us/meeting/register/hkyxUQF7SfSoCLByeC5pTQ';

const NamedDefault = () => <>
  Our next <a href={CONNECTION_CALL_URL}>
  IS Connection Call</a> is on <b>Friday, August 28<sup>th</sup> at 1:00-1:55pm Pacific Time (4pm Eastern, 8pm UTC)</b>.
</>;
